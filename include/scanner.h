...
class Token{
	public:
	    ...
	    WIREFRAME, HISTOGRAM_2D, PARALLEL_COORDINATES, RADAR,
	    QUIVER, STREAMPLOT, TREND,
            ...
            DESCRIPTION, FORMAT, JSON, CHART,DESCRIBE,TYPE,CORRELATION,IMPORTANCE,STEPS,STOP,CONTINUE,
