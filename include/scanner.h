...
class Token{
	public:
	    ...
	    AREA, STACKED_BAR, MULTI_LINE, VIOLIN, CONTOUR, SURFACE, CANDLESTICKS,
	    WIREFRAME, HISTOGRAM_2D,TREND, TIME,FOR_COLUMNS, SEC, SECS, MINUTE,
            REALTIME,REFRESH_INTERVAL,HISTORY_WINDOW,MAX_DATA_POINTS,AUTO_RANGE_Y,
            SAMPLING,SAMPLING_METHOD,EVERY_N,AVERAGE,MAX_VAL,MIN_VAL,LAST_VAL,Y_COLUMNS,
            MINUTES,HOUR,HOURS,OPEN_COLUMN,CLOSE_COLUMN,HIGH_COLUMN,LOW_COLUMN,VOLUME_COLUMN,
	        ...
	        HORIZON,SCENARIOS,COLUMNS,EXCLUDE,WITH_CONDITIONS_FROM,
            ...
            DETECT, PREPARE, LAGS, ROLLING_WINDOWS, ADD_DATETIME_FEATURES,ADD_SEASONAL_FEATURES,
            NO_AUTO_DETECT,CHECK_STATIONARITY,MAKE_STATIONARY,VALIDATION,SPLIT,TEST,
