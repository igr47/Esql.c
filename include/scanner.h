...
class Token{
	public:
	    ...
	    TIME_SERIES,QQ_PLOT,RESIDUALS,ANIMATION,INTERACTIVE,DASHBOARD,CANDLESTICK,
	    PARALLEL_COORDINATES,RADAR,QUIVER,STREAMPLOT,GEO_MAP,MAP,GEO_SCATTER,GEO_HEATMAP,GEO_CHOROPLETH,CHOROPLETH,
	    GEO_BUBBLE,GEO_LINE,GEO_CONTOUR,GEO_POLYGON,GEO_GRID,GEO_FLOW,LATITUDE,LAT,LON,LONGITUDE,REGION,VALUE,
	    ...
	    WIREFRAME, HISTOGRAM_2D,TREND, TIME,FOR_COLUMNS,
            ...
            // Simulation 
            SIMULATE, MARKET,WITH_SCENARIO,GENERATE,INDICATORS,INTERVAL, REAL_TIME, DELAY, EMIT_EVENTS,
            PATHS,NOISE,SEASONALITY,VOLATILITY_CLUSTERING,MEAN_REVERSION,MEAN_REVERSION_STRENGTH,
            VOLATILITY_SCALE,SPREAD,LIQUIDITY_IMPACT,SLIPPAGE,MICROSTRUCTURE,
            ...
            COMPREHENSIVE,METRICS,RANKING,EARLY_STOPPING,DEVICE,NUM_THREADS,METRIC,
            BOOSTING,SEED,VALIDATION_TABLE,VALIDATION_SPLIT,DETERMINISTIC,FOLDS,ROUNDS,
            TUNE_HYPERPARAMETERS,SEQUENTIAL,JOBS,SCORING,WITH_TUNING_GRID,RANGE,
            DATA_SAMPLING,NO_FEATURE_SCALING,SCALING,RATIO,MAX_FEATURES,RANDOM,
	    HORIZON,SCENARIOS,COLUMNS,
			...
			//Panctuation
			COMMA,DOT,SEMICOLON,L_PAREN,R_PAREN,COLON,SLASH,L_BRACKET,R_BRACKET,
			//Special
			END_OF_INPUT,ERROR
		};
		Type type;
