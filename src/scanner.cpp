...
void Lexer::initializeKeyWords(){
	keywords={
		...
		{"CHECK",Token::Type::CHECK},   {"SURFACE", Token::Type::SURFACE},
                ...
                {"JULIANDAY", Token::Type::JULIANDAY},   {"SIMULATE", Token::Type::SIMULATE},
                {"ROW_NUMBER", Token::Type::ROW_NUMBER}, {"MARKET", Token::Type::MARKET},
                {"RANK", Token::Type::RANK},             {"WITH_SCENARIO", Token::Type::WITH_SCENARIO},
                {"DENSE_RANK", Token::Type::DENSE_RANK}, {"INDICATORS", Token::Type::INDICATORS},
                {"NTILE", Token::Type::NTILE},           {"INTERVAL", Token::Type::INTERVAL},
                {"LAG", Token::Type::LAG},               {"REAL_TIME", Token::Type::REAL_TIME},
                {"LEAD", Token::Type::LEAD},             {"DELAY", Token::Type::DELAY},
                {"FIRST_VALUE", Token::Type::FIRST_VALUE},{"EMIT_EVENTS", Token::Type::EMIT_EVENTS},
                {"LAST_VALUE", Token::Type::LAST_VALUE},   {"PATHS", Token::Type::PATHS},
                {"OVER", Token::Type::OVER},              {"NOISE", Token::Type::NOISE},
                {"PARTITION", Token::Type::PARTITION},    {"SEASONALITY", Token::Type::SEASONALITY},
                {"WITHIN", Token::Type::WITHIN},           {"VOLATILITY_CLUSTERING", Token::Type::VOLATILITY_CLUSTERING},
                {"SUBSTR", Token::Type::SUBSTR},         {"MEAN_REVERSION", Token::Type::MEAN_REVERSION},
                {"CONCAT", Token::Type::CONCAT},        {"MEAN_REVERSION_STRENGTH", Token::Type::MEAN_REVERSION_STRENGTH},
                {"LENGTH", Token::Type::LENGTH},       {"VOLATILITY_SCALE", Token::Type::VOLATILITY_SCALE},
                {"UPPER", Token::Type::UPPER},       {"SPREAD", Token::Type::SPREAD},
                ...
                {"HEADER", Token::Type::HEADER},    {"DETECT", Token::Type::DETECT},
                {"DELIMITER", Token::Type::DELIMITER},  {"TIME", Token::Type::TIME},
                {"RESIDUALS", Token::Type::RESIDUALS},  {"PREPARE", Token::Type::PREPARE},
                {"ANIMATION", Token::Type::ANIMATION},  {"PREPARE", Token::Type::PREPARE},
                {"INTERACTIVE", Token::Type::INTERACTIVE},  {"LAGS", Token::Type::LAGS},
                {"DASHBOARD", Token::Type::DASHBOARD},     {"ROLLING_WINDOWS", Token::Type::ROLLING_WINDOWS},
                {"GEO_MAP", Token::Type::GEO_MAP},         {"ADD_DATETIME_FEATURES", Token::Type::ADD_DATETIME_FEATURES},
                {"CANDLESTICK", Token::Type::CANDLESTICK}, {"ADD_SEASONAL_FEATURES", Token::Type::ADD_SEASONAL_FEATURES},
                {"PARALLEL_COORDINATES", Token::Type::PARALLEL_COORDINATES}, {"NO_AUTO_DETECT", Token::Type::NO_AUTO_DETECT},
                {"RADAR", Token::Type::RADAR},                                {"CHECK_STATIONARITY", Token::Type::CHECK_STATIONARITY},
                {"QUIVER", Token::Type::QUIVER},            {"MAKE_STATIONARY", Token::Type::MAKE_STATIONARY},
                ...
                {"EPS", Token::Type::EPS},               {"REALTIME", Token::Type::REALTIME},
                {"REFRESH_INTERVAL", Token::Type::REFRESH_INTERVAL}, {"CANDLESTICKS", Token::Type::CANDLESTICKS},
                {"HISTORY_WINDOW", Token::Type::HISTORY_WINDOW},     {"SEC", Token::Type::SEC},
                {"MAX_DATA_POINTS", Token::Type::MAX_DATA_POINTS},   {"SECS", Token::Type::SEC},
                {"AUTO_RANGE_Y", Token::Type::AUTO_RANGE_Y},         {"MINUTE", Token::Type::MINUTE},
                {"SAMPLING", Token::Type::SAMPLING},                 {"MINUTES", Token::Type::MINUTE},
                {"SAMPLING_METHOD", Token::Type::SAMPLING_METHOD},   {"HOUR", Token::Type::HOUR},
                {"EVERY_N", Token::Type::EVERY_N},                   {"HOURS", Token::Type::HOUR},
                {"AVERAGE", Token::Type::AVERAGE},                   {"OPEN_COLUMN", Token::Type::OPEN_COLUMN},
                {"Y_COLUMNS", Token::Type::Y_COLUMNS},               {"CLOSE_COLUMN", Token::Type::CLOSE_COLUMN},
                {"JPG", Token::Type::JPG},                           {"HIGH_COLUMN", Token::Type::HIGH_COLUMN},
                {"JPEG", Token::Type::JPEG},                         {"LOW_COLUMN", Token::Type::LOW_COLUMN},
                {"GIF", Token::Type::GIF},                           {"VOLUME_COLUMN", Token::Type::VOLUME_COLUMN},
                {"MP4", Token::Type::MP4},
